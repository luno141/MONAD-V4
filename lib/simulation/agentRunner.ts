...
export const INITIAL_PLAYER_AGENTS: Agent[] = [
  {
    ...
    operatingCost: 1.5,
    deploymentCost: 50,
    availableCapital: 250,
    currentTask: 'Trading Spices in Khari Baoli',
    contract: {
      targetCommodity: 'spices',
      buyBelow: 11,
      sellAbove: 15,
      maxCapital: 300,
      minAcceptableProfit: 5,
    ...
    totalExpenses: 45,
    netProfit: 135,
    speechBubble: 'Looking for cheap spice deals... 🌶️',
  ...
  },
  {
    ...
    operatingCost: 2.0,
    deploymentCost: 60,
    availableCapital: 180,
    currentTask: 'Hauling Grain to Chandni Chowk',
    contract: {
    ...
    totalExpenses: 35,
    netProfit: 85,
    speechBubble: 'Moving cargo on Chandni Chowk route! 🌾',
